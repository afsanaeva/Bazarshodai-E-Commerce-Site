...
require PATH_LIB . "3a-lib-products6.php";
$pdtLib = new Products6();
$products6 = $pdtLib->get();
...
<html>
  <head>
    <title>
    Diploma Milk Powder (1kg)
    </title>
    <link rel="stylesheet" href="public/3c-theme.css">
    <script src="public/4a-cart6.js"></script>
  </head>
  <body>
    <div>
    <div class="logo">
    ...
    <div id="page-products"><?php
      if (is_array($products6)) {
        foreach ($products6 as $id => $row) { ?>
          <div class="pdt">
