...
require __DIR__ . DIRECTORY_SEPARATOR . "lib" . DIRECTORY_SEPARATOR . "2a-config6.php";
switch ($_POST['req']) {
  /* [INVALID REQUEST] */
  default:
  ...
  case "show":
    // Fetch products
    require PATH_LIB . "2b-lib-db6.php";
    require PATH_LIB . "4c-lib-cart6.php";
    $cartLib = new Cart();
    $products6 = $cartLib->details();
    ...
    <table id="cart-table">
      ...
      if (count($_SESSION['cart'])>0) {
      foreach ($_SESSION['cart'] as $id => $qty) {
        $sub = $qty * $products6[$id]['product_price'];
        $total += $sub; ?>
      <tr>
        <td>
