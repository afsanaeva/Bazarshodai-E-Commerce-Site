...
require __DIR__ . DIRECTORY_SEPARATOR . "lib" . DIRECTORY_SEPARATOR . "2a-config5.php";
switch ($_POST['req']) {
  /* [INVALID REQUEST] */
  default:
  ...
  case "show":
    // Fetch products
    require PATH_LIB . "2b-lib-db5.php";
    require PATH_LIB . "4c-lib-cart5.php";
    $cartLib = new Cart();
    $products5 = $cartLib->details();
    ...
    <table id="cart-table">
      ...
      if (count($_SESSION['cart'])>0) {
      foreach ($_SESSION['cart'] as $id => $qty) {
        $sub = $qty * $products5[$id]['product_price'];
        $total += $sub; ?>
      <tr>
        <td>
